...
import FunctionDefinitionsRat as funcs
...
#[InsonationSiteVelocity,InsonationSiteFlow,InsonationSitePressure,time]=funcs.timecourse(params.StartTime,params.EndTime,params.dt,reflect_coeff,char_admit,wave_prop_constant,SteadyFlow,UtCompliance,'Uterine')

#Qfactor = funcs.flow_factor(params.vessels,params.SA_IVS,CharacteristicAdmittance,WaveProp,ReflectionCoefficients)

##funcs.any_timecourse(params.StartTime,params.EndTime,params.dt,Qfactor,CharacteristicAdmittance)

##Output to screen key properties of the flow velocity waveform
#funcs.flow_velocity_properties(InsonationSiteVelocity)

##Output to screen key properties of pressure wave form
...
#    plt.title('Uterine artery Pressure waveform')
#    plt.plot(time,InsonationSitePressure/133.)
#    plt.show()
